const value = {
    canonical_source: 'https://github.com/sanskrit-coders/indic-transliteration/blob/master/src/test/resources/transliterationTests.json',
    ...
    devanaagarii_round_trip: [
        ...
        },
        {
            ...
            gurmukhi: 'ਅਗ੍ਨਿਮੀਲ਼ੇ ਪੁਰੋਹਿਤਂ ਯਜ੍ਞਸ੍ਯ ਦੇਵਮृਤ੍ਵਿਜਮ੍',
        ...
        },
        {
            ...
            TODO: 'Fix gujrAti test',
            dev: 'अंशाइ पड़िब फ़कीर ज़रूर',
            oriya: 'ଅଂଶାଇ ପଡ଼ିବ ଫ଼କୀର ଜ଼ରୂର',
            gujarati: 'અંશાઇ પડ઼િબ ફ઼કીર જ઼રૂર',
            assamese: 'অংশাই পড়িৱ',
            gurmukhi: 'ਅਂਸ਼ਾਇ ਪੜਿਬ ਫ਼ਕੀਰ ਜ਼ਰੂਰ',
            itrans: 'aMshaai pa.Diba fakiira zaruura',
        },
        {
            description: 'Tests R RR',
            titus: 'vr̥kṣyaṃ havīṃṣi gr̥hyanta r̥̄ṇamu pitr̥̄n//',
    ...
    from_devanaagarii: [
        {
            ...
            gurmukhi: 'ਅਸਯ ਔਸ਼ਧਿਃ ਗ੍ਰਨ੍ਥਃ! ॡਕਾਰੋ ਨਾਸ੍ਤਿ ਲੇਸ਼ੋऽਪਿ ਸਂਸ਼ਯਃ। ਕੀਲਕਮ੍? ਕੂਪਿਃ?  ਕਸ਼੍ਠਂ ਭੋਃ। ਸ਼ਙ੍ਕਰ! ਜ੍ਞਾਨਮ੍।  ਸਞ੍ਜੀਵਯ। ੧੨੩੪੫॥ ੴ ਤਤ੍। ਅਬ ਅਵ',
        },
        {
            description: 'A general test for Roman scripts without equivalents for some devanAgarI letters, like optitrans',
            dev: 'पड़िब छीड़ा ऴ ऱ',
            // optitrans: 'pa.Diba Chii.Daa .La .Rha',
        },
        {
